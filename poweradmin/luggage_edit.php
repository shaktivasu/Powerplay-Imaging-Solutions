...
if(isset($_POST['signupsubmit']))
{
	 ...
	 if($_POST['delivery_charge'] > 0 )
	  $news_edit = "update power_luggage set luggage_status='".$_POST['luggage_status']."',luggage_vehicle='".$_POST['vehicle']."',luggage_doordelivery='Yes',luggage_doorcharges='".$_POST['delivery_charge']."',unloading_charges ='".$_POST['unloading_charge']."',create_date ='".$_POST['luggage_date']."',luggage_sender='".$_POST['luggage_sender']."',luggage_sender_phone='".$_POST['luggage_sender_phone']."',luggage_reciever='".$_POST['luggage_reciever']."',luggage_reciever_phone='".$_POST['luggage_reciever_phone']."',luggage_fees='".$_POST['luggage_fees']."',luggage_charges='".$_POST['luggage_charges']."'   where id=".$id."";
	 else 
	 $news_edit = "update power_luggage set luggage_status='".$_POST['luggage_status']."',luggage_vehicle='".$_POST['vehicle']."',luggage_doorcharges='".$_POST['delivery_charge']."',unloading_charges ='".$_POST['unloading_charge']."',create_date ='".$_POST['luggage_date']."',luggage_sender='".$_POST['luggage_sender']."',luggage_sender_phone='".$_POST['luggage_sender_phone']."',luggage_reciever='".$_POST['luggage_reciever']."',luggage_reciever_phone='".$_POST['luggage_reciever_phone']."',luggage_fees='".$_POST['luggage_fees']."',luggage_charges='".$_POST['luggage_charges']."'   where id=".$id."";
