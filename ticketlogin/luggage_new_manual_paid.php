...
$sel_man2=mysqli_fetch_array($sel_man1);$sel_man3 = mysqli_num_rows($sel_man1);
/*$sel_man_booked = "select * from  power_manual_child where lr_no = 'Nil' and  agent_id = ".$_SESSION['route']." order by id ";
$sel_man_booked1 = mysqli_query($objConn,$sel_man_booked);
$sel_man_booked3 = mysqli_num_rows($sel_man_booked1);*/
...
$max2=$rtn2[0].'-MP-'.$sel_man2['manual_id'];
$total_price = 0;
 $luggage_price = 0;
 $unluggage_price = 0;
 $total_qty =1;}
		...
		<div class="grid_container">
		  <div class="grid_12">
		    <div class="widget_wrap">
              ...
              <div class="widget_content"><?php if($sel_man3==0){ echo " Manual Reciept Book not provided.";
			  }
			  else
			  {?>
                  ...
                  <tr>
                    ...
                    <td><table width="100%" height="178" border="0" align="center" cellpadding="0" cellspacing="5" class="widget_wrap">
                      ...
                      <tr>
                        ...
                        <td class="new_title">Booking Type&nbsp;<img src="images/alert.gif" ></td>
                        <td><input type="radio" name="pay_method" id="pay_method" value="Paid"  checked>
                          <strong>Paid</strong>
                         	<!-- <input type="radio" name="pay_method" id="pay_method" value="To Pay"  onClick="this.form.submit();">
                           <strong> To Pay</strong>
						<input type="radio" name="pay_method" id="pay_method" value="Credit">
                          <strong>Credit</strong>--></td>
                        <td class="new_title">Delayed Booking
                          <input type="checkbox" name="delayedbooking" id="delayedbooking"></td>
                        <td>&nbsp;</td>
                      </tr>
                      <tr>
                        <td height="33" class="new_title">&nbsp;</td>
                        ...
                        <input id="lrno" name="lrno" type="text"  maxlength="100" class="large" value="<?php echo $max2;?>"  readonly/></td>
                        <td class="new_title"><!--Vechile-->Luggage Ref.No</td>
                        <td><input id="luggage_ref" name="luggage_ref" type="text"  maxlength="100" class="large"  /></td>
                        </tr>
...
<input id="sender_address" name="sender_address" type="text"  maxlength="100" class="large"   tabindex="7"  value="<?php echo $_SESSION['route_name'];?>"/>
                      ...
                      <tr>
                        ...
                        <td class="new_title">Booking Date</td>
                        <td> <script>DateInput('todate', true, 'yyyy-mm-dd','<?php echo $todate; ?>')</script></td>
                      </tr>
			  ...
			  <tr>
                   ...
                   <td  align="left" bgcolor="#FFFFFF" ><input name="prd_qunty[]" type="text" class="large" id="prd_qunty<?php echo ($i+1); ?>" size="3" maxlength="3" value="1"   onKeyUp="qtycount()" onkeypress="if(enter_pressed(event)){ return false; } else { return numbersonly(this, event, false); }" tabindex="11"></td>
                     ...
                     <?php */?><input name="prd_weight<?php echo ($i+1); ?>" type="text" class="large" id="prd_weight<?php echo ($i+1); ?>" size="4" maxlength="4" value="0"   onKeyUp="qtycount()" onkeypress="if(enter_pressed(event)){ return false; } else { return numbersonly(this, event, false); }" tabindex="11" >
                     </td>
