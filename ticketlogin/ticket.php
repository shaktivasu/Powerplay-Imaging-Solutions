		...
		<div class="grid_container">
		  ...
		  <div class="grid_12">
		    <div class="widget_wrap">
              ...
              <div class="widget_content">
                <table  class="display">
                  <tr ><td><h3>Ticket Type :</h3></td>
                        <td><h3><?php echo $_REQUEST['type'];?></h3></td>
				  </tr> </thead>
                      <tr><td ><h3>Name :</h3></td>
                        <td><input name="name"; type="text"  maxlength="80" class="large"  style="border:1px solid red;" /></td>
				  </tr>
				  <tr ><td ><h3>Email :</h3></td>
                        <td><input name="name"; type="text"  maxlength="80" class="large"  style="border:1px solid red;" /></td>
				  </tr>
				   <tr ><td ><h3>Product Name :</h3></td>
                        <td><input name="name"; type="text"  maxlength="80" class="large"  style="border:1px solid red;" /></td>
				  </tr>
				   ...
				   <tr ><td ><h3>Message :</h3></td>
                        <td><textarea name="name"; maxlength="100"   style="border:1px solid red;" ></textarea></td>
				  </tr>
				    <tr ><td ><h3>Priority :</h3></td>
                        <td><select>
						<option>Low</option>
				    ...
				    <tr ><td ><h3>Captcha Text :</h3></td>
                        <td><input name="name"; type="text"  maxlength="80" class="large"  style="border:1px solid red;" /><img src="images/captcha.png">
						</td>
				  </tr>
				    <tr ><td >
									</td>
                        <td>
						<input id="signupsubmit" name="signup" type="submit" class="btn_small btn_blue" value="Submit a Ticket">&nbsp;<input id="signupsubmit" name="signup" type="submit" class="btn_small btn_blue" value="Cancel">
									</td>
				  </tr>
                </table>
