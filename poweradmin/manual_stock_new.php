...
if(isset($_POST['signupsubmit']))
{
	...
	$qty = $_POST['qty'];
	$to = $from+($qty*200)-1;
	$dup = "select * from power_manual_stock where from_id = ".$from;
	$dup1 = mysqli_query($objConn,$dup);
	$dup2 = mysqli_num_rows($dup1);
	if($dup2==0)
	{
	$news_ins = "INSERT INTO power_manual_stock (agent_id, from_id, to_id,qty,create_date) VALUES('".$veno."','".$from."',".$to.",".$qty." ,'".$create_date."')";
	$news_ins1 = mysqli_query($objConn,$news_ins);
		header('Location:manual_stock.php?msg=1');
	}
	else
	header('Location:manual_stock.php?msg=2');
					...
					<div class="widget_content">
							...
							<ul>
                             <li>
								<div class="form_grid_12">
									<label class="field_title" id="lfirstname" for="firstname">Book Inward Date<span class="req">*</span></label>
                        ...
                        <option value="0">Select Any</option>
                          <?php 
                            ...
                            <li>
								<div class="form_grid_12">
									<label class="field_title" id="lfirstname" for="firstname">From  No.<span class="req">*</span></label>
									<div class="form_input">
										<input id="from_no" name="from_no" type="text" value="" maxlength="100" class="large"/>
									</div>
								</div>
								</li>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
										<input id="qty" name="qty" type="text" value="" maxlength="100" class="large"/>
									</div>
								</div>
								</li>
