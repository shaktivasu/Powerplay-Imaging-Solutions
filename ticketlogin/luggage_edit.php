...
if(isset($id) && $id!='')
{
 $get_editable_news=mysqli_query($objConn,"select * from power_ticket where id=".$id."") or die("edit News Error:".mysql_error());
...
if(isset($_POST['signupsubmit']))
{
	 ...
	 if($_POST['delivery_charge'] > 0 )
	  $news_edit = "update power_ticket set luggage_status='".$_POST['luggage_status']."',luggage_vehicle='".$_POST['vehicle']."',luggage_doordelivery='Yes',luggage_doorcharges='".$_POST['delivery_charge']."',unloading_charges ='".$_POST['unloading_charge']."',create_date ='".$_POST['luggage_date']."',luggage_sender='".$_POST['luggage_sender']."',luggage_sender_phone='".$_POST['luggage_sender_phone']."',luggage_reciever='".$_POST['luggage_reciever']."',luggage_reciever_phone='".$_POST['luggage_reciever_phone']."',luggage_fees='".$_POST['luggage_fees']."',luggage_charges='".$_POST['luggage_charges']."'   where id=".$id."";
	 else 
	 $news_edit = "update power_ticket set luggage_status='".$_POST['luggage_status']."',luggage_vehicle='".$_POST['vehicle']."',luggage_doorcharges='".$_POST['delivery_charge']."',unloading_charges ='".$_POST['unloading_charge']."',create_date ='".$_POST['luggage_date']."',luggage_sender='".$_POST['luggage_sender']."',luggage_sender_phone='".$_POST['luggage_sender_phone']."',luggage_reciever='".$_POST['luggage_reciever']."',luggage_reciever_phone='".$_POST['luggage_reciever_phone']."',luggage_fees='".$_POST['luggage_fees']."',luggage_charges='".$_POST['luggage_charges']."'   where id=".$id."";
	...
	echo $news_edit2 = "update power_ticket_prd set luggage_prd_name = '".$get_prd2['particulars']."',luggage_qunty='".$_POST['luggage_qunty']."',luggage_charge='".$_POST['luggage_loading']."',luggage_uncharge='".$_POST['luggage_unloading']."'  where luggage_lrno='".$_POST['luggage_lrno']."'";
		...
		<h3>Edit Luggage Details</h3>
					...
					<div class="widget_content">
						<form id="signupform" name="signupform"  autocomplete="off" method="post" action="#" class="form_container left_label" onsubmit="return newsval();">
                            ...
                            <li>
                                ...
                                <li>
								<div class="form_grid_12">
									<label  id="lfirstname" for="firstname">Sender Name & Phone Number<span class="req">*</span></label>
									<div class="form_input"> <input type="text" name="luggage_sender" id="luggage_sender" value="<?php echo $get_editable_news_row['luggage_sender']?>" class="large" ><br><input type="text" name="luggage_sender_phone" id="luggage_sender_phone" value="<?php echo $get_editable_news_row['luggage_sender_phone']?>" class="large" >
                                  </strong></div>
								</div>
								</li>
                                 <li>
								...
								<div class="form_grid_12">
                                    ...
                                    <?php $get_prd = "select * from power_ticket_prd where luggage_lrno ='".$get_editable_news_row['luggage_lrno']."'";
									$get_prd1 = mysqli_query($objConn,$get_prd);
									$get_prd2 = mysqli_fetch_array($get_prd1);
                    ...
                    <option value="0">Select Any</option>
                      <?php 
                                ...
                                <?php 
							$luggage_prd = "select * from power_ticket_prd where luggage_lrno = '".$get_editable_news_row['luggage_lrno']."'";
