...
$todate = date("Y-m-d");
//$max=mysqli_num_rows(mysqli_query($objConn,"select * from  power_ticket where luggage_paymethod='To Pay'"));
//$max1=$max+1+500;
...
$max2=$rtn2[0].'-MT-'.$sel_man2['manual_id'];
$total_price = 0;
 $luggage_price = 0;
 $unluggage_price = 0;
 $total_qty =1;}
                  ...
                  <tr>
                    ...
                    <td><table width="100%" height="178" border="0" align="center" cellpadding="0" cellspacing="5" class="widget_wrap">
                      ...
                      <tr>
                        ...
                        <td><!--<input type="radio" name="pay_method" id="pay_method" value="Paid"  onClick="this.form.submit();">
                          <strong>Paid</strong>-->
                          <input type="radio" name="pay_method" id="pay_method" value="To Pay"   checked>
