		...
		<div class="grid_container">
		  <div class="grid_12">
		    <div class="widget_wrap">
		      ...
		      <form id="bookingform" name="bookingform" autocomplete="off" method="post"  class="form_container left_label" action="luggage_new_manual_credit.php" onSubmit="return val();"  >
