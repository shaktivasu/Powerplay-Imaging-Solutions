...
if(isset($_POST['signupsubmit']))
{
	...
	while($take2 = mysqli_fetch_array($take1))
	{
		if($take2['sales_qty']<=($take2['qty']))
		{
			...
			if($tot_sales<=$take2['qty'])
			{
				...
				$news_ins = "INSERT INTO power_manual_credit_sales (group_id, from_id, to_id,qty,create_date) VALUES('".$_POST['group_id']."','".$from."',".$to.",".$_POST['sales_qty']." ,'".$create_date."')";
				$news_ins1 = mysqli_query($objConn,$news_ins);
				$max_issue = "select max(id) from power_manual_credit_sales";
				$max_issue1 = mysqli_query($objConn,$max_issue);
				$max_issue2 = mysqli_fetch_row($max_issue1);
				for($i=$from;$i<=$to;$i++)
				{
						echo $news_ins = "INSERT INTO power_manual_credit_child (issue_id , group_id, manual_id, lr_no) VALUES('".$max_issue2[0]."','".$_POST['group_id']."','".$i."', 'Nil')";
						$news_ins1 = mysqli_query($objConn,$news_ins);
				}
				
				header('Location:manual_stock_credit_sales.php?msg=1');
				exit;
			}
	...
	header('Location:manual_stock_credit_sales.php?msg=1');exit;
			...
			<div class="grid_12">
				<div class="widget_wrap">
					<div class="widget_top">
						...
						<h6>Add New Manual Book Issue (Credit)</h6>
                    ...
                    <?php if($_REQUEST['msg']==1) echo "Quantity Mismatch.";?>
                        ...
                        <option value="0">Select Any</option>
                          <?php 
                            ...
                            <li>
								<div class="form_grid_12">
									<label class="field_title" id="lfirstname" for="firstname">Credit Group<span class="req">*</span></label>
									<div class="form_input">
										<select name="group_id" id="group_id" class="limiterBox" tabindex="2" onChange="recieveraddress(this.value);">
                        <option value="0">Select Any</option>
                          <?php 
										$route = mysqli_query($objConn,"select * from power_manual_credit_group ");
										while($route1 = mysqli_fetch_array($route))
										{
											 
											echo "<option value=".$route1['id'].">".$route1['group_name']."</option>";
										}
