...
if(isset($_POST['signupsubmit']))
{
	...
	$collection_amt = $_POST['collectin_amt'];
	$particulars = $_POST['particulars'];
	if($_POST['collection_status']==1)
	{
	$news_ins = "INSERT INTO power_luggage (luggage_lrno,luggage_from, luggage_fees , create_date,luggage_paymethod) VALUES('".$particulars."','".$_SESSION['route']."','".$collection_amt."', '".$create_date."','Expenses')";
	}
	...
	{
		$news_ins = "INSERT INTO power_transfer (route_id,particulars,collection_amount, collection_status , collection_date,bank_name,branch_name,chq_no,chq_date) VALUES('".$_SESSION['route']."','".$particulars."','".$collection_amt."',0, '".$create_date."','".$_POST['bank_name']."','".$_POST['branch_name']."','".$_POST['chq_no']."','".$_POST['chq_date']."')";
	}
...
function yesnoCheck() {
	...
	if(document.getElementById('collection_transfer').checked)
	{
						...
						<form id="signupform" name="signupform"  autocomplete="off" method="post" action="#" class="form_container left_label" onsubmit="return newsval();">
                           ...
                           <li>
								<div class="form_grid_12">
									...
									<div class="form_input">
									<input name="collection_status" id="collection_status" type="radio" value="0"   onclick="javascript:reciept();" class="disabled" >Reciept&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="collection_status" id="collection_status"type="radio" value="1" onclick="javascript:voucher();" class="disabled" checked>Voucher&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="collection_status" id="collection_transfer"type="radio" value="2" onclick="javascript:yesnoCheck();"  >Bank Transfer
									</div>
								</div>
								</li>
                                <li>
								<div class="form_grid_12">
									...
									<div class="form_input">
									<input name="collection_party"  type="radio" value="0"  id="creditCheck"  onclick="javascript:activecrdit();"  disabled >Credit Client&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input name="collection_party" type="radio" value="1"  id="agentCheck" onclick="javascript:activeagent();" disabled>Agent
									</div>
								</div>
								</li>
                                <li>
								<div class="form_grid_12">
                                    ...
                                    <?php $agnt = "select * from power_route where id <>".$_SESSION['route'];
									...
									{
										?><option value="<?php echo $crdt2['id']?>"><?php echo $crdt2['credit']?></option><?php 
										}
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
										<input type="text" name="particulars" id="particulars" value="" maxlength="100" class="large" >
									</div>
								</div>
								</li>
								...
								<div class="form_grid_12">
									...
									<div class="form_input">
										<input type="text" name="collectin_amt" id="collection_amt" value="" maxlength="100" class="large" onkeypress="if(enter_pressed(event)){ return false; } else { return numbersonly(this, event, false); }">
									</div>
								</div>
								</li>
