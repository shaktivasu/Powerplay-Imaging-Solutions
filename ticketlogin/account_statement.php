...
<br>
					...
					<div class="widget_content">
						...
						<tr>
                            ...
                            <th width="13%">Reciept Amount (Rs.)</th>
					 ...
					 $luggage=mysqli_query($objConn,"select * from power_collections_ho where route_id = ".$_SESSION['route']."  order by id asc") or die("Vehicle error:".mysql_error());
				   ...
				   ?>
						<tr <?php if($css_set==0) echo "class=gradeX"; else  echo "class=gradeC"; ?>>
							...
							<td align="center"><?php echo date('d-M-Y',strtotime($luggage_row['collection_date']));?></td>
                            <td align="left"><?php echo $luggage_row['particulars']; ?></td>
							<td align="right"><?php echo number_format($luggage_row['collection_amount'],2);
							$tot_amount +=$luggage_row['collection_amount'];
							?></td>
                        ...
                        <tr>
                        <td colspan="4" align="right"  bgcolor="#F9C6F1"><strong>Total Amount : 
						<?php echo number_format($tot_amount,2) ;?></strong></td>
                        </tr>
						</tbody>
						</table>
