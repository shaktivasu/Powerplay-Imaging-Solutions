   ...
   <form name="frm" id="frm" method="post" action="">
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse:collapse;" class="arrow_box_content top_arrow">
      ...
      <tr>
		...
		<?php /*?><input type="text"  name="lrno" id="lrno" value="<?php echo $_POST['lrno']?>"><?php */?>
      ...
      <tr>
       <td colspan="5"></td>
				  ...
				  if($_POST['route_to']!=0)
				  {
					 ...
					 <table class="display">
						<thead>
						<tr><th width="4%"><span class="yellow_pro">INWARD</span></th>
							<th width="4%">
								 Sl No
							</th>
							<th width="7%">Date</th>
...
<?php */?>						</tr>
					...
					//echo "select * from power_luggage where  luggage_to = ".$routewise3[0]." and luggage_status = 'Dispatched'  and create_date between  $frmdate and $todate";
                      ...
                      $luggage=mysqli_query($objConn,"select * from power_luggage where  luggage_to='".$_POST['route_to']."' and luggage_status = 'New Arrival'   and create_date between  '".$frmdate."' and '".$todate."'") or die("Vehicle error:".mysql_error());					 
				   ...
				   ?>
						...
						<td align="center"> <input type="checkbox" name="del[]"  id="del[]" value="<?php echo $luggage_row['id']; ?>"  > 
...
<?php */?>						</tr>
					...
					//echo "select * from power_luggage where  luggage_to = ".$routewise3[0]." and luggage_status = 'Dispatched'  and create_date between  $frmdate and $todate";
                     ...
                     $luggage=mysqli_query($objConn,"select * from power_luggage where  luggage_to = ".$routewise3[0]." and luggage_status = 'New Arrival'  and create_date between  '".$frmdate."' and '".$todate."'") or die("Vehicle error:".mysql_error());
