...
if(isset($_POST['signupsubmit']))
{
	...
	$news_ins = "INSERT INTO power_collections_credit (route_id, collection_amount , collection_status , collection_date) VALUES('".$veno."','".$collection_amt."', 0,'".$create_date."')";
	
	
	$news_ins1 = mysqli_query($objConn,$news_ins);
	header('Location:collections_party.php?msg=1');
					...
					<div class="widget_content">
						<form id="signupform" name="signupform"  autocomplete="off" method="post" action="#" class="form_container left_label" onsubmit="return newsval();">
                          ...
                          <?php 
								...
								<li>
								<div class="form_grid_12">
									<label class="field_title" id="lfirstname" for="firstname">Colletion Amount.<span class="req">*</span></label>
									<div class="form_input">
