...
<!-------------  Alert Box  ----------------------------->
	...
	function takeDetails(str)
	{
		...
		xmlhttp.open("GET","luggage_credit.php?q="+str,true);
		xmlhttp.send();
	}
	...
	<div id="content">
		  ...
		  <div class="grid_12">
		    <div class="widget_wrap">
		      ...
		      <div class="widget_top">
						...
						<h6>Add New luggage<font color="red"> [Credit]</font></h6>
		...
		?>
                      ...
                      <tr>
                        ...
                        <td><div id="txtphone"><input id="sender_phone" name="sender_phone" type="text"  maxlength="100" class="large"  onkeypress="if(enter_pressed(event)){ return false; } else { return numbersonly(this, event, false); }" tabindex="7" disabled />
                            <br>
                            <br>
<input id="sender_address" name="sender_address" type="text"  maxlength="100" class="large"   tabindex="7"  disabled/>
                        </div></td>
