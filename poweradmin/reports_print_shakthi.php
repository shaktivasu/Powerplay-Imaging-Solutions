			...
			<div class="grid_12">
				<div class="widget_wrap" style="overflow:auto">
                   ...
                   <tr>
                                ...
                                <tr>
                                <td height="20" colspan="2">Payment : Cheque/DD in favour of ' <strong>KMP Speed Parcel Service</strong> ' Only.</td>
                                <td><strong>Total Consignment :</strong></td>
                                <td><?php  echo number_format($invoice_id['invoice_consignment'],2); 
								?></td>
                                </tr>
...
IFSC&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:&nbsp;&nbsp;ICIC0000016<br>
                                  ...
                                  <td height="20"><strong>Total Qty : </strong></td>
                                  <td><?php  echo number_format($invoice_id['invoice_qty'],2); 
								?></td>
                                </tr>
                                <tr>
                                  <td height="20"><strong>Invoice Weight : </strong></td>
                                  <td><span style="font-size:10px;font-weight:bold;">
                                    <?php  echo number_format($invoice_id['invoice_weight'],2); 
									$inv_amount = $invoice_id['invoice_amount'];
								?>
                                    </span></td>
                                </tr>
                                  <tr>
                                  ...
                                  <td><span style="font-size:10px;font-weight:bold;">Rs.
                                    <?php  echo number_format($invoice_id['invoice_amount'],2); 
								?>
                                    /-</span></td>
                                </tr>
                                <tr>
               ...
               <br><br>
                   ...
                   <tr>
                   <td>1.</td><td>Credit Booking</td><td align="right"><?php echo $inv_amount;?></td><td></td></tr>
                   <tr>
				   ...
				   ?></td></tr>
                    ...
                    <tr><td></td><td><strong>Closing Balance</strong></td><td align="right"><strong><?php echo $total_credit_debit  = $inv_amount - $total_debit;  ?></strong></td><td align="right"></td></tr>
