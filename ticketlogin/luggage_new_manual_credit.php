...
$todate = date("Y-m-d");
//$max=mysqli_num_rows(mysqli_query($objConn,"select * from  power_ticket where luggage_paymethod='Credit'"));
//$max1=$max+1+560;
//$date = date_create();
//date_timestamp_get($date);
$chk_grp = "select * from power_manual_credit where credit_id = ".$_POST['credit_code'];
...
if($sel_man3>0){
$get_c = "select * from power_credit where id = ".$_POST['credit_code'];
$get_c1 = mysqli_query($objConn,$get_c);
$get_c2 = mysqli_fetch_array($get_c1);
$get_amt = "select * from power_credit_route where credit_id = '".$_POST['credit_code']."' and  route_id = ".$_POST['route_to'];
$get_amt1 = mysqli_query($objConn,$get_amt);
$get_amt2 = mysqli_fetch_array($get_amt1);
$reciever_address = mysqli_fetch_row(mysqli_query($objConn,"select route from power_route where id = ".$_POST['route_to']));
...
$max2=$rtn2[0].'-MC-'.$sel_man2['manual_id'];
$total_price = 0;
 $luggage_price = 0;
 $unluggage_price = 0;
 $total_qty =1;
...
function qtycount()
	{
	 ...
	 for(i=1; i<=tot; i++) {
		...
		luggagetotoal = parseFloat(document.getElementById(txtqty).value) +parseFloat(luggagetotoal);
		 ...
		 if (document.getElementById('item_type').value=='BOX' )
		 document.getElementById(txtprice).value =  parseFloat(document.getElementById(txtqty).value) * parseFloat(document.getElementById(txtunitprice).value)
		 else 
...
<li><a href="settings.php"><span class="nav_icon cog"></span>Settings</a></li>
	...
	<div id="content">
		  ...
		  <div class="grid_12">
		    <div class="widget_wrap">
		      ...
		      <div class="widget_top">
						...
						<h6>Add New luggage <font color="red" style="font-size:22px"> [CREDIT - MANUAL]</font></h6>
                  ...
                  <tr>
                    ...
                    <td width="79%"><table width="100%" border="1">
                      <tr>
                        ...
                        <td width="20%"><?php /*?><select name="vehicle" class="limiterBox1" tabindex="1">
                  ...
                  <tr>
                    ...
                    <td><table width="100%" height="178" border="0" align="center" cellpadding="0" cellspacing="5" class="widget_wrap">
                      ...
                      <tr>
                        ...
                        <td>
                        <input name="pay_method" id="pay_method" type="hidden" value="Credit"  >
                        ...
                        <option value="0">Select Any</option>
                          <?php 
										...
										?>
                        </select><?php */?><script>DateInput('todate', true, 'yyyy-mm-dd','<?php echo $todate; ?>')</script></td>
                        </tr>
                      ...
                      <tr>
                        ...
                        <?php echo $_SESSION['route_name'];?>    
                                          </td>
                        <td class="new_title">Route To</td>
                        <td><select name="route_to" class="limiterBox" tabindex="2" >
                         
                          <?php 
										$route = mysqli_query($objConn,"select * from power_route where id= ".$_POST['route_to']." order by route");
										while($route1 = mysqli_fetch_array($route))
										{
                      ...
                      <tr>
                        ...
                        <td><?php /*?><?php if($_SESSION['route']==21){?> <?php */?> <?php echo $get_c2['credit'];?><div>
                                
                        
                                <div>
                                    <input
                                        id="sender_suggestions" name="sender_suggestions" type="hidden"   tabindex="3">
                               </div>
                            </div>
		...
		?>
							...
							?><?php */?>
						<input type="hidden" name="sender_id" id="sender_id" value="<?php echo $_POST['credit_code']?>">
                        ...
                        <td>
                       <?php /*?> <?php if($_SESSION['route']!=21){ 
						?>
						<?php echo $get_c2['credit'];?> <div>
			  ...
			  while($sel2 = mysqli_fetch_array($sel1))
			  {
				  echo '<option value="'.$sel2['id'].'">'.$sel2['luggage_reciever'].'</option>';
		...
		?>
                                ...
                                <div>
                                    <input
                                        id="reciever_suggestions" name="reciever_suggestions" type="hidden"  tabindex="6" class="large"  >
                                </div>
                            </div>
						<?php 
						}
		...
		?>
                                ...
                                <div><?php */?>
                                    <input
                                        id="reciever_suggestions" name="reciever_suggestions"  tabindex="6" class="large"  >
                                </div>
                            </div>
                           <?php /*?> <?php }?><?php */?>
                        </td>
                      ...
                      <tr>
                        ...
                        <?php /*?> <?php if($_SESSION['route']==21){ 
						?><?php */?>
                        <div id="txtphone"><input id="sender_phone" name="sender_phone" type="text"  maxlength="100" class="large"  onkeypress="if(enter_pressed(event)){ return false; } else { return numbersonly(this, event, false); }" tabindex="7" value="<?php echo $get_c2['credit_phone']; ?>" />
                       <?php /*?> <?php } else
						{?>
						<div id="txtphone"><input id="sender_phone" name="sender_phone" type="text"  maxlength="100" class="large"  onkeypress="if(enter_pressed(event)){ return false; } else { return numbersonly(this, event, false); }" tabindex="7"  />
						<?php
						}?><?php */?>
                            <br>
                            <br>
<input id="sender_address" name="sender_address" type="text"  maxlength="100" class="large"   tabindex="7"  value="<?php echo $_SESSION['route_name'];?>"/>
                        </div></td>
                        <td class="new_title">Reciever Phone No &amp; Address</td>
                        <td>
                         <?php /*?><?php if($_SESSION['route']==21){ ?>
						 <div id="txtphone1"><input id="reciever_phone" name="reciever_phone" type="text"  maxlength="100" class="large"onkeypress="if(enter_pressed(event)){ return false; } else { return numbersonly(this, event, false); }" tabindex="9" />
						 <?php
						 }else{
						?><?php */?>
                        <div id="txtphone1"><input id="reciever_phone" name="reciever_phone" type="text"  maxlength="100" class="large"onkeypress="if(enter_pressed(event)){ return false; } else { return numbersonly(this, event, false); }" tabindex="9"  value=""/>
                        <?php /*?><?php }?><?php */?>
                         <br><br></div>
                         <div id="reciever_address1"><input id="reciever_address" name="reciever_address" type="text"  maxlength="100" class="large" tabindex="9" value="<?php echo $reciever_address[0]?>"/></div></td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td class="new_title">Driver Name & Contact No.</td>
                  ...
                  <tr>
                    ...
                    <td width="78%"><table width="100%" height="100" border="0" align="center" cellpadding="0" cellspacing="0" class="widget_wrap">
                      ...
                      <tr>
                        ...
                        <td align="center"><strong>Qty / Weight</strong></td>
			  ...
			  <tr>
                   ...
                   <?php /*?>     <select id="sender" style="display: none;" onChange="this.value();"  tabindex="3">
                                   <?php $sel = "select * from power_particulars";
			  $sel1 = mysqli_query($objConn,$sel);
			  $sel3 = mysqli_num_rows($sel1);
			  $co=0;
			  while($sel2 = mysqli_fetch_array($sel1))
			  {
				  echo '<option value="'.$sel2['id'].'">'.$sel2['particulars'].'</option>';;
		...
		?>
                                ...
                                <div>
                                    <input id="sender_suggestions" name="sender_suggestions"  tabindex="3" class="large"  >
                   <?php */?><select name="prd_name[]"  id="prd_name<?php echo ($i+1);?>" class="limiterBox" tabindex="10">
                    <option value="0">Select Any</option>
                      <?php 
                    ...
                    <td  align="left"  bgcolor="#FFFFFF" ><input name="prd_qunty[]" type="text" class="large" id="prd_qunty<?php echo ($i+1); ?>" size="3" maxlength="4" value="1"   onKeyUp="qtycount()" onkeypress="if(enter_pressed(event)){ return false; } else { return numbersonly(this, event, false); }" tabindex="11"></td>
                     <td  align="left" bgcolor="#FFFFFF" ><input name="credit_item" type="hidden" class="large" id="credit_item" value="<?php echo $get_c2['credit_item'];?>" ><input name="item_type" type="hidden" class="large" id="item_type" value="<?php echo $get_c2['credit_item'];?>" >
                    <?php echo $get_c2['credit_item'];  if($get_c2['credit_item']=='WEIGHT') {?> <input name="prd_weight<?php echo ($i+1); ?>" type="text" class="large" id="prd_weight<?php echo ($i+1); ?>" size="4" maxlength="4" value="1"   onKeyUp="qtycount()" onkeypress="if(enter_pressed(event)){ return false; } else { return numbersonly(this, event, false); }" tabindex="11"  style="border-color:#FF8484;"><?php } ?> 
                     
                     </td>
                      <td  align="left" bgcolor="#FFFFFF"><input name="prd_unitprice[]"type="text"  class="large1" id="prd_unitprice<?php echo ($i+1); ?>" size="10" maxlength="10"  value="<?php echo $get_amt2['route_amount']; ?>" tabindex="14" onKeyUp="qtycount()"></td>
                    <td  height="20" align="center" bgcolor="#FFFFFF"><input name="prd_price[]" type="text"  class="large1" id="prd_price<?php echo ($i+1); ?>" size="10" maxlength="10"  onKeyUp="particularcharge()"  readonly tabindex="14" value="<?php echo $get_amt2['route_amount']; ?>"></td>
                    <td height="20" align="center" bgcolor="#FFFFFF"><input name="prd_charge[]" type="text"  class="large1" id="prd_charge<?php echo ($i+1); ?>" size="10" maxlength="10"  onKeyUp="luggagecharge()"  onkeypress="if(enter_pressed(event)){ return false; } else { return numbersonly(this, event, false); }" tabindex="16" value="0"></td>
                    <td   height="20" align="center" bgcolor="#FFFFFF"><input name="prd_uncharge[]" type="text"  class="large1" id="prd_uncharge<?php echo ($i+1); ?>" size="10" maxlength="10"  onKeyUp="luggageuncharge()"  onkeypress="if(enter_pressed(event)){ return false; } else { return numbersonly(this, event, false); }" tabindex="17" value="0"></td>
                    <input type="hidden" name="totaltxt" id="totaltxt" value="<?php echo @$vals; ?>" />
                    <td width="0%"  height="20" align="center" bgcolor="#FFFFFF">&nbsp;</td>
                    </tr> <tr>
                ...
                <table width="50%" height="81" border="0" align="right" cellpadding="0" cellspacing="0" >
			     ...
			     <tr>
			       ...
			       <td width="19%"><div id="txtluggage1">
			         <input id="unluggage_amount" name="unluggage_amount" type="hidden"  value="<?php echo $unluggage_price?>" maxlength="50"  class="large" />
