...
{
$id=$_GET['event_id'];
$del_news=mysqli_query($objConn,"delete from power_expenses   where id=".$id."") or die("Delete Collection Error:".mysql_error());
header("location:expenses_list.php?msg=3");
}
$frmdate = date("Y-m-d");
$todate = date("Y-m-d");
...
$routestr=" route_id='".$_POST['route_from']."' "; 
else
$routestr=" 1=1 ";
//echo "select * from power_expenses where $routestr create_date>='".$_POST['frmdate']."' and create_date<='".$_POST['todate']."'";

if($_POST['Submit'])
	 $news_events_flow=mysqli_query($objConn,"select * from power_expenses where $routestr ") or die("Collection error:".mysql_error());
			...
			<div class="grid_12">
				<div class="widget_wrap">
					<div class="widget_top">
						...
						<h6>Expenses Management</h6>
                        <div class="add_new"><h6><a href="expenses.php">Addnew</a></h6></div>
					</div>
      ...
      <tr>
        ...
        <td width="87" align="center" class="label_txt">&nbsp;</td>
						...
						<tr>
							...
							<th width="16%">Expenses Amount</th>
				   ...
				   ?>
						<tr <?php if($css_set==0) echo "class=gradeX"; else  echo "class=gradeC"; ?> >
							...
							<td align="center">
							<?php $route_name = mysqli_fetch_row(mysqli_query($objConn,"select route from power_route where id=".$news_events_flow_row[1]));
								  echo $route_name[0];
							?></td>
							<td class="center">
							<?php 
							...
							?></td>
							<td class="center"><?php 
							  echo $news_events_flow_row[3];
							?></td>
							<td class="center"><?php echo date('d-M-Y',strtotime($news_events_flow_row[4]));?></td>
							<td class="center">
							<span>
                           <a href="expenses_edit.php?id=<?php echo $news_events_flow_row[0]; ?>"  title="Edit"><img src="images/edit.png"/></a></span>
                            <span><a href="expenses_list.php?news=del&amp;event_id=<?php echo $news_events_flow_row[0];?>" onclick="return confirmSubmit();" title="delete"><img src="images/delete.png"/></a></span>
							</td>
						</tr>
