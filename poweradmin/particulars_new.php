...
if(isset($_POST['signupsubmit']))
{
	...
	$news_ins = "INSERT INTO power_particulars (particulars, particulars_status, create_date) VALUES('".$veno."','0', '".$create_date."')";
	
	
	$news_ins1 = mysqli_query($objConn,$news_ins);
	header('Location:particulars.php?msg=1');
