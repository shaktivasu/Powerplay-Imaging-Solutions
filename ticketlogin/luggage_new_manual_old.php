...
<li><a href="settings.php"><span class="nav_icon cog"></span>Settings</a></li>
	...
	<div class="page_title">
		...
		<h3>Parcel Booking&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="luggage_new_paid.php"><input name="paid" type="button" class="orange_block" value="   Paid   "></a>&nbsp;&nbsp;&nbsp;&nbsp; <a href="luggage_new_topay.php"><input type="button" class="not_valid"  value="To Pay"></a>&nbsp;&nbsp;&nbsp;&nbsp; <a href="luggage_new_credit.php"><input type="button"  value="Credit"  class="green_block"></a>&nbsp;&nbsp;&nbsp;&nbsp; <a href="luggage_new_manual.php"><input type="button"  value="Manual"  class="ac_over"></a></h3>
	...
	<div id="content">
                    ...
                    <td><table width="100%" height="178" border="0" align="center" cellpadding="0" cellspacing="5" class="widget_wrap">
                      ...
                      <tr>
                        ...
                        <td><input type="radio" name="pay_method" id="pay_method" value="Paid" checked>
                          <strong>Paid</strong>
                          <input type="radio" name="pay_method" id="pay_method" value="To Pay">
                      ...
                      <tr>
                        ...
                        <td>  <div>
                                <?php /*?><select id="sender" style="display: none;" onChange="this.value();" tabindex="3" >
                                   <?php $sel = "select * from power_customers where cust_route = ".$_SESSION['route'];
		...
		?>
                        ...
                        <td>
                         <div>
                               <?php /*?> <select id="reciever" style="display: none;" tabindex="4">
                                   <?php $sel = "select * from power_customers where cust_route = ".$_SESSION['route'];
			  $sel1 = mysqli_query($objConn,$sel);
			  $sel3 = mysqli_num_rows($sel1);
			  $co=0;
                  ...
                  <tr>
                    ...
                    <td width="78%"><table width="100%" height="100" border="0" align="center" cellpadding="0" cellspacing="0" class="widget_wrap">
                      ...
                      <tr>
                        ...
                        <td  align="center"><strong>Fright Price</strong></td>
                          ...
                          <div id="files">
                            <div id="file-<?php echo ($i+1); ?>">
                              <table width="100%" border="1" cellspacing="1" cellpadding="20" >
                                <tr>
                                  <td width="31%"  height="20" align="center" bgcolor="#FFFFFF"   ><select name="prd_name[]"  id="prd_name<?php echo ($i+1);?>" class="limiterBox" tabindex="10">
                                    <option value="0">Select Any</option>
                                    <?php 
                                  ...
                                  <td  align="left" bgcolor="#FFFFFF" width="15%"><input name="prd_qunty[]" type="text" class="large" id="prd_qunty<?php echo ($i+1); ?>" size="3" maxlength="3" value="1"   onKeyUp="qtycount()" onkeypress="if(enter_pressed(event)){ return false; } else { return numbersonly(this, event, false); }" tabindex="11"></td>
                                  <td width="24%"  height="20" align="center" bgcolor="#FFFFFF"><input name="prd_price[]" type="text"  class="large1" id="prd_price<?php echo ($i+1); ?>" size="10" maxlength="10"  onKeyUp="particularcharge()" onkeypress="if(enter_pressed(event)){ return false; } else { return numbersonly(this, event, false); }" tabindex="12"></td>
                                  <td width="15%"  height="20" align="center" bgcolor="#FFFFFF"><input name="prd_charge[]" type="text"  class="large1" id="prd_charge<?php echo ($i+1); ?>" size="10" maxlength="10"  onKeyUp="luggagecharge()"  onkeypress="if(enter_pressed(event)){ return false; } else { return numbersonly(this, event, false); }" tabindex="13"></td>
                                  <td width="15%"  height="20" align="center" bgcolor="#FFFFFF"><input name="prd_uncharge[]" type="text"  class="large1" id="prd_uncharge<?php echo ($i+1); ?>" size="10" maxlength="10"  onKeyUp="luggageuncharge()"  onkeypress="if(enter_pressed(event)){ return false; } else { return numbersonly(this, event, false); }" tabindex="14"></td>
