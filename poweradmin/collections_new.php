...
if(isset($_POST['signupsubmit']))
{
	...
	$news_ins = "INSERT INTO power_collections (route_id, collection_amount , collection_status , collection_date) VALUES('".$veno."','".$collection_amt."', 0,'".$create_date."')";
	
	
	$news_ins1 = mysqli_query($objConn,$news_ins);
	header('Location:collections.php?msg=1');
