...
{
$id=$_GET['event_id'];
$del_news=mysqli_query($objConn,"update power_collections set collection_status = 1  where id=".$id."") or die("Delete Collection Error:".mysql_error());
header("location:collections.php?msg=3");
}
$frmdate = date("Y-m-d");
$todate = date("Y-m-d");
...
//echo "select * from power_collections where $routestr collection_date>='".$_POST['frmdate']."' and collection_date<='".$_POST['todate']."'";

if($_POST['Submit'])
	 $news_events_flow=mysqli_query($objConn,"select * from power_collections where $routestr collection_date>='".$_POST['frmdate']."' and collection_date<='".$_POST['todate']."'") or die("Collection error:".mysql_error());
else
 	 $news_events_flow=mysqli_query($objConn,"select * from power_collections where $routestr collection_date>='".date('Y-m-d')."' and collection_date<='".date('Y-m-d')."'") or die("Collection error:".mysql_error());
?>
<!DOCTYPE HTML>
<html>
<head>
			...
			<div class="grid_12">
				<div class="widget_wrap">
					<div class="widget_top">
						<span class="h_icon users_2"></span>
						<h6>Collections Management</h6>
                        <div class="add_new"><h6><a href="collections_new.php">Addnew</a></h6></div>
					</div>
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="0" style="border-collapse:collapse;" class="arrow_box_content top_arrow">
      ...
      <tr>
        ...
        <td width="87" align="center" class="label_txt">&nbsp;</td>
                    ...
                    ?>
                        <tr>
                        <td colspan="10" align="center" valign="middle" bgcolor="#F9C6F1">No Collections.</td>
                        </tr>
                   <?php
				   }
				   else
				   ...
				   ?>
						<tr <?php if($css_set==0) echo "class=gradeX"; else  echo "class=gradeC"; ?> >
							...
							<td align="center">
							<?php $route_name = mysqli_fetch_row(mysqli_query($objConn,"select route,route_comission_topay from power_route where id=".$news_events_flow_row[1]));
								  echo $route_name[0];
							?></td>
							<td class="center">
							<?php 
							  echo $news_events_flow_row[2];
							?></td>
							<td class="center"><?php 
							...
							<td class="center">
							<span>
                           <a href="collections_edit.php?id=<?php echo $news_events_flow_row[0]; ?>"  title="Edit"><img src="images/edit.png"/></a></span>
                            <span><a href="collections.php?news=del&amp;event_id=<?php echo $news_events_flow_row[0];?>" onclick="return confirmSubmit();" title="delete"><img src="images/delete.png"/></a></span>
							</td>
						</tr>
