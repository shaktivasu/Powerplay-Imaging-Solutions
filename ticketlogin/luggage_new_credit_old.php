...
<li><a href="settings.php"><span class="nav_icon cog"></span>Settings</a></li>
	...
	<div id="content">
		...
		?>
                                ...
                                <div>
                                    <input
                                        id="sender_suggestions" name="sender_suggestions"  tabindex="3" class="large"  >
                                </div>
                            </div>                       
...
<input id="sender_address" name="sender_address" type="text"  maxlength="100" class="large"   tabindex="7"/>
			  ...
			  <tr>
                    <td width="31%"  height="20" align="center" bgcolor="#FFFFFF"   >
