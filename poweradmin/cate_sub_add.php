...
if(isset($_REQUEST['Submit']))
{
	...
	$max=$sel2[0]+1;
	$dis="select max(category_display) from power_menu where category_parent=".$parent;
	...
	$desc = str_replace('"', '&quot;', $desc);
	 ...
	 $ins="insert into power_menu values(".$max.",'".$catname."','".$target_path."','".$desc."','".$title."',".$status.",".$parent.",0,0,0,".$dis3.")";
	 $ins1=mysqli_query($objConn,$ins);
	 header('Location:cate_sub_list.php?id='.$parent.'&res=added');
}
?>
        ...
        <td height="300" align="left" valign="top" bgcolor="#FFFFFF" class="box"><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td align="right"><table width="100" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="60" align="left" valign="middle"><a href="cate_sub_list.php?id=<?php echo $_REQUEST['id'];?>" class="innerlink" onclick="return val();">category List</a></td>
              </tr>
            </table></td>
          </tr>
          <tr>
            <td colspan="2" align="center" valign="middle"><form action="" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return callMe();">
              <table width="700" border="0" cellpadding="2" cellspacing="2">
                <tr>
                  <td colspan="3" align="center" valign="middle" class="pagehead">Add Sub Category</td>
                </tr>
                <tr>
                  <td colspan="3">&nbsp;</td>
                </tr>
                <tr>
                  ...
                  <td width="574" align="left" valign="middle"><input name="catname" type="text" id="textfield" size="50" />
                      <input name="parent" type="hidden" id="parent" size="50" value="<?php echo $_REQUEST['id']?>" />
                      <input name="parent_parent" type="hidden" id="parent" size="50" value="<?php echo $_REQUEST['par']?>" />                  </td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td align="left" valign="top" class="text">:</td>
                  <td align="left" valign="middle"><span class="row1">
                ...
                <tr>
                  ...
                  <td align="left" valign="middle"><input type="submit" name="Submit" id="Submit" value=" Add " />
                    &nbsp;
                    <input name="button2" type="button" id="button2" onclick="MM_goToURL('parent','cate_sub_list.php?id=<?php echo $_GET['id'];?>&par=<?php echo $_GET['par'];?>');return document.MM_returnValue" value="Cancel" /></td>
                </tr>
                <tr>
                  <td align="left" valign="middle">&nbsp;</td>
                  <td align="left" valign="middle">&nbsp;</td>
