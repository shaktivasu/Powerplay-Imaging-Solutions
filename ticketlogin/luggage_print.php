...
<style type="text/css"media="print">@media print 
 {
 body { margin: 0; background-image: none; font-size: 8pt;  }
 h5 { 
...
<body onLoad="window.print();" ><!-- -->
                  ...
                  <?php 
				   $routewise = "select * from power_route where id in (select luggage_to from power_ticket where create_date>='".$_GET['frmdate']."' and create_date<='".$_GET['todate']."' $vecstr"." and luggage_status = 'Dispatched' and  luggage_from = '".$_SESSION['route']."' )";
				  ...
				  ?>
                         ...
                         <?php
					$luggage=mysqli_query($objConn,"select * from power_ticket where luggage_to = ".$routewise3[0]." and  luggage_from = '".$_SESSION['route']."' and luggage_status = 'Dispatched' and create_date>='".$_GET['frmdate']."' and create_date<='".$_GET['todate']."' $vecstr") or die("Vehicle error:".mysql_error());
                    ...
                    ?><div align="center">
                        ...
                        <table class="display"  border="1" cellpadding="0" cellspacing="0" width="95%" style="vertical-align:middle;" >
						<thead>
				   ...
				   ?>
						<tr style="padding:2px;">
                            ...
                            <td align="left" style="padding:5px;"><?php echo $luggage_row['luggage_sender'].' & '.$luggage_row['luggage_sender_phone']; ?></td>
                            <td align="left" style="padding:5px;"><?php echo $luggage_row['luggage_reciever'].' & '.$luggage_row['luggage_reciever_phone']; ?></td>
