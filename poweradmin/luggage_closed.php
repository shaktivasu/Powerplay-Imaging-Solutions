...
{
$id=$_GET['event_id'];
$del_news=mysqli_query($objConn,"update power_luggage set luggage_status = 'Delivered'  where id=".$id."") or die("Delete News Error:".mysql_error());
...
<?php */?>						</tr>
					...
					//echo "select * from power_luggage where  luggage_to = ".$routewise3[0]." and luggage_status = 'Dispatched'  and create_date between  $frmdate and $todate";
                     ...
                     $luggage=mysqli_query($objConn,"select * from power_luggage where  luggage_to = ".$routewise3[0]." and  luggage_status='Delivered'  and create_date between  '".$frmdate."' and '".$todate."'") or die("Vehicle error:".mysql_error());
