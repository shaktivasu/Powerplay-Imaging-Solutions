...
if(isset($id) && $id!='')
{
echo $get_editable_news=mysqli_query($objConn,"select * from power_route where id=".$id."") or die("edit News Error:".mysql_error());
...
{
	 echo $news_edit = "update power_route set route='".$_POST['route']."' ,route_type='".$_POST['route_type']."' ,route_username='".$_POST['route_username']."' ,route_password='".$_POST['route_password']."' ,route_address='".$_POST['route_address']."' ,route_phone='".$_POST['route_phone']."' ,route_comission_paid='".$_POST['route_paid']."' ,route_comission_topay='".$_POST['route_topay']."' ,route_comission_credit='".$_POST['route_credit']."',route_delivery_paid='".$_POST['delivery_paid']."' ,route_delivery_topay='".$_POST['delivery_topay']."' ,route_delivery_credit='".$_POST['delivery_credit']."' , route_status = '".$_POST['status']."',route_group='".$_POST['route_group']."',route_nature='".$_POST['route_nature']."'  where id=".$id."";
	$news_edit1 = mysqli_query($objConn,$news_edit);
	header('Location:route.php?msg=2');
			...
			<div class="grid_12">
				<div class="widget_wrap">
					<div class="widget_top">
						...
						<h6>Edit Customer</h6><div class="go_back"><h6><a href="route.php">Go Back</a></h6></div>
					</div>
						...
						<form id="signupform" name="signupform"  autocomplete="off" method="post" action="#" class="form_container left_label" onsubmit="return newsval();">
                            ...
                            <li>
								<div class="form_grid_12">
                                    ...
                                    <input id="route" name="route" type="text"  maxlength="100" class="large" value="<?php echo $get_editable_news_row['route']?>"/></div>
								</div>
								</li>
                                ...
                                <li>
								<div class="form_grid_12">
									<label class="field_title" id="lfirstname" for="firstname">Customer Username<span class="req">*</span></label>
									<div class="form_input">
                                    <input id="route_username" name="route_username" type="text"  maxlength="100" class="large" value="<?php echo $get_editable_news_row['route_username']?>"/></div>
								</div>
								</li>
                                <li>
								<div class="form_grid_12">
									<label class="field_title" id="lfirstname" for="firstname">Customer Password<span class="req">*</span></label>
									<div class="form_input">
                                    <input id="route_password" name="route_password" type="text"  maxlength="100" class="large" value="<?php echo $get_editable_news_row['route_password']?>"/></div>
								</div>
								</li>
                                 <li>
								<div class="form_grid_12">
									...
									<div class="form_input">
                                    <input id="route_address" name="route_address" type="text"  maxlength="100" class="large" value="<?php echo $get_editable_news_row['route_address']?>"/></div>
								</div>
								</li>
                                 <li>
								<div class="form_grid_12">
									<label class="field_title" id="lfirstname" for="firstname">Phone No.<span class="req">*</span></label>
									<div class="form_input">
                                    <input id="route_phone" name="route_phone" type="text"  maxlength="100" class="large" value="<?php echo $get_editable_news_row['route_phone']?>"/></div>
								</div>
								</li>
