...
<div id="container">
    ...
    <div class="social_activities">
				<a href="route.php"><div class="activities_s">
					<div class="block_label" style="width:100%">
						<img src="images/icons/5.png">&nbsp;SERVICE CENTER
                        
					</div>
                    <div class="title">
					</div>
				</div></a>
				<a href="credit.php"><div class="activities_s">
					<div class="block_label" style="width:100%">
						<img src="images/icons/5.png">&nbsp;CREDIT CLIENT 
					</div>
                    <div class="title">
					</div>
				</div></a>
               <a href="expenses_list.php"> <div class="activities_s">
					<div class="block_label" style="width:100%">
						<img src="images/icons/5.png">&nbsp;EXPENSES
					</div>
                    <div class="title">
					</div>
				</div></a>
				
                <a href="bank.php"> <div class="activities_s">
					<div class="block_label" style="width:100%">
						<img src="images/icons/5.png">&nbsp;BANK LEDGER
					</div>
                    <div class="title">
					</div>
				</div></a>
