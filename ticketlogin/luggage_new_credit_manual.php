...
$max=mysqli_fetch_row(mysqli_query($objConn,"select max(id) from power_ticket where luggage_paymethod='Credit'"));
$max1=$max[0]+1;
//$date = date_create();
...
$get_amt = "select * from power_credit_route where route_id = ".$_POST['route_to'];
                  ...
                  <tr>
                    ...
                    <td><table width="100%" height="178" border="0" align="center" cellpadding="0" cellspacing="5" class="widget_wrap">
                      ...
                      <tr>
                        ...
                        <td><select name="route_to" class="limiterBox" tabindex="2" onChange="recieveraddress(this.value);">
                      ...
                      <tr>
                        ...
                        <td>
                        <div>
                                <select  style="display: none;"  tabindex="4" >
...
<input id="sender_address" name="sender_address" type="text"  maxlength="100" class="large"   tabindex="7"/>
                        ...
                        <td><div id="txtphone1"><input id="reciever_phone" name="reciever_phone" type="text"  maxlength="100" class="large"onkeypress="if(enter_pressed(event)){ return false; } else { return numbersonly(this, event, false); }" tabindex="9"/>
                         <br><br></div>
                         <div id="reciever_address1"> <input id="reciever_address" name="reciever_address" type="text"  maxlength="100" class="large" tabindex="9"/></div></td>
                      </tr>
                       ...
                       <tr>
                        ...
                        <td>
                        <input type="text" name="door_collection" id="door_collection" value="0" readonly class="large" onkeypress="if(enter_pressed(event)){ return false; } else { return numbersonly(this, event, false); }">
                        </td>
                        <td class="new_title">LR Charges</td>
                        <td> <input type="text" name="lr_charges" id="lr_charges" value="0" readonly class="large" onkeypress="if(enter_pressed(event)){ return false; } else { return numbersonly(this, event, false); }"></td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td>
                        <input type="text" name="oda_charges" id="oda_charges" value="0" readonly class="large" onkeypress="if(enter_pressed(event)){ return false; } else { return numbersonly(this, event, false); }">
                        </td>
                        <td class="new_title"></td>
                        <td> </td>
                      </tr>
		...
		?>
                   ...
                   <?php */?><select name="prd_name[]"  id="prd_name<?php echo ($i+1);?>" class="limiterBox" tabindex="10">
                    ...
                    <td  align="left"  bgcolor="#FFFFFF" ><input name="prd_qunty[]" type="text" class="large" id="prd_qunty<?php echo ($i+1); ?>" size="3" maxlength="3" value="1"   onKeyUp="qtycount()" onkeypress="if(enter_pressed(event)){ return false; } else { return numbersonly(this, event, false); }" tabindex="11"></td>
                     <td  align="left" bgcolor="#FFFFFF" ><input name="credit_item" type="hidden" class="large" id="credit_item" value="<?php echo $get_c2['credit_item'];?>" >
                    <?php echo $get_c2['credit_item'];  if($get_c2['credit_item']=='WEIGHT') {?> <input name="prd_weight<?php echo ($i+1); ?>" type="text" class="large" id="prd_weight<?php echo ($i+1); ?>" size="3" maxlength="3" value="1"   onKeyUp="qtycount()" onkeypress="if(enter_pressed(event)){ return false; } else { return numbersonly(this, event, false); }" tabindex="11"  style="border-color:#FF8484;"><?php } ?> 
                    ...
                    <td height="20" align="center" bgcolor="#FFFFFF"><input name="prd_charge[]" type="text"  class="large1" id="prd_charge<?php echo ($i+1); ?>" size="10" maxlength="10"  onKeyUp="luggagecharge()"  onkeypress="if(enter_pressed(event)){ return false; } else { return numbersonly(this, event, false); }" tabindex="16"></td>
                    <td   height="20" align="center" bgcolor="#FFFFFF"><input name="prd_uncharge[]" type="text"  class="large1" id="prd_uncharge<?php echo ($i+1); ?>" size="10" maxlength="10"  onKeyUp="luggageuncharge()"  onkeypress="if(enter_pressed(event)){ return false; } else { return numbersonly(this, event, false); }" tabindex="17"></td>
