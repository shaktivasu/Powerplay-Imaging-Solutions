                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td width="79%"><table width="100%" border="1">
                      <tr>
                        <td width="10%"><div class="note_title1">Ticket Type</div></td>
                        <td width="60%">
                      ...
                      <!-- <script>
					    ...
					    function service()
					   {
                        ...
                        <h4>
                        <input name="booking1" type="radio" value="SALES" onClick="document.location.href='power_ticket.php?type=sales'">SALES&nbsp;&nbsp;&nbsp;
                        <input name="booking2" type="radio" value="SERVICE"  onClick="document.location.href='power_ticket.php?type=service'" >SERVICE&nbsp;&nbsp;&nbsp;
